  ...
  return (
    <div>
      ...
      <div className="jojo md:h-[150px] p-5 flex items-center">
        <p className="flex items-center gap-2 mt-3 md:text-4xl text-2xl uppercase font-bold text-white">
          <FaDotCircle className="md:text-xl" /> Track & Trace
        </p>
      </div>
      <div className="p-5">
        <p>Tracking Number:</p>
        ...
        <div className="md:px-20">
          <div className="grid md:grid-cols-2 md:gap-2">
            <section className="border-2 border-black p-3 mt-2 md:mt-10">
              <p className="text-xl font-bold uppercase md:mt-5">
                Shipper Information
              </p>
              <div className="md:mt-10 mt-5">
                <p>
                  <b>Name: </b>Steve Wesley
                </p>
                <p>
                  <b>Address: </b>South Carolina.
                </p>
                <p>
                  <b>Email: </b>{" "}
                  <a href="mailto:stevewesley37@gmail.com">
                    stevewesley37@gmail.com
                  </a>
                </p>
              </div>
            </section>
            ...
            <section className="border-2 border-black p-3 mt-2 md:mt-10">
              <p className="text-xl font-bold uppercase mt- md:mt-5">
                Receiver Information
              </p>
              <div className="md:mt-10 mt-5">
                <p>
                  <b>Name: </b>Judi Warman
                </p>
                <p>
                  <b>Address: </b>1018 Sweet Amy Way Sellersburg, IN 47172.
                </p>
                <p>
                  <b>Email: </b>{" "}
                  <a href="mailto:jwarm1284@gmail.com">jwarm1284@gmail.com</a>
                </p>
              </div>
            </section>
          </div>
        ...
        <div>
          <p className="text-lg font-bold underline md:mt-10 mt-5">
            Tracking Route:
          </p>
          <div>
          ...
          <div>
            ...
            <div className="md:h-[150px] h-[100px] border-l-4 border-dotted border-black p-2 px-2 md:px-7 ml-2 mt-1">
              <p className="font-normal">Ankara, Turkey.</p>
              <p className="font-normal">August 22, 2024, 05:00am.</p>
            </div>
          </div>
          <div>
            <div className="flex items-center gap-3 text-lg md:text-2xl font-extrabold">
              <FaLandmark className="text-2xl" />
              <p>Departed GlobalShipWave Facility.</p>
            </div>
            <div className="md:h-[150px] h-[100px] border-l-4 border-dotted border-black p-2 px-2 md:px-7 ml-2 mt-1">
              <p className="font-normal">Ankara, Turkey.</p>
          ...
          <div>
            <div className="flex items-center gap-3 text-lg md:text-2xl font-extrabold">
              <FaLandmark className="text-2xl" />
              <p>Departed at GlobalShipWave Facility.</p>
            </div>
            <div className="md:h-[150px] h-[100px] border-l-4 border-dotted border-black p-2 px-2 md:px-7 ml-2 mt-1">
              <p className="font-normal">
                New York USA enroute to sellersburg Indiana USA
              </p>
              <p className="font-normal">June 13, 2025, 07:00am.</p>
            </div>
          </div>
        </div>
      </div>
